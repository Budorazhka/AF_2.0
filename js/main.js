...
(function () {
  ...
  if (typeof Lenis !== "undefined" && !reducedMotion) {
    ...
    // Доступ для оверлеев (шахматка): остановить/запустить плавный скролл,
    // иначе колесо над открытой панелью прокручивает и страницу под ней
    window.AF_lenis = lenis;
